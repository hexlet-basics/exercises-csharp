...
Чтобы в строке начала работать интерполяция перед ее началом надо добавить знак «доллара» – **$**. Обратите внимание что знак стоит _до_ открывающей кавычки, а не _после_ неё.
