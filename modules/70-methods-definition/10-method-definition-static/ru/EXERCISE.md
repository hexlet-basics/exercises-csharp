...
Реализуйте класс `App` со статическим методом с именем `PrintMotto()`, который выведет на экран фразу _Winter is coming_. Тесты будут вызывать ваш код вот так:
